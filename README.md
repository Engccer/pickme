...
**파일 업로드:**
1. "CSV 파일" 탭에서 "📁 csv 파일을 선택하세요" 버튼 클릭
2. 준비한 CSV 파일 선택
3. 학생 수 확인 후 "다음" 버튼 클릭

**팁:** 엑셀에서 작성 후 "CSV UTF-8 (쉼표로 분리)"로 저장하세요.
...
4. **제외할 학생** (CSV 사용자만, 선택)
   - CSV 파일을 업로드한 경우, "제외할 학생이 있나요?" 섹션이 표시됩니다
   - 클릭하여 펼친 후 선발 대상에서 제외할 학생을 선택할 수 있습니다
   - 직접 입력 사용자는 1단계 미리보기에서 이미 삭제 기능을 사용할 수 있습니다
